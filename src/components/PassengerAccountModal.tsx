...
export const PassengerAccountModal: React.FC<PassengerAccountModalProps> = ({
  ...
  const handlePartnerSubmit = async (e: React.FormEvent) => {
    ...
    const newApp: PartnerApplication = {
      ...
      userId: currentUid,
      type: appType,
      companyName: appType === 'company' ? (companyName || '') : '',
      managerName: appType === 'company' ? (managerName || '') : '',
      driverName: appType === 'independent_driver' ? (driverName || '') : '',
      vehicleModel: appType === 'independent_driver' ? (vehicleModel || '') : '',
      plateNumber: appType === 'independent_driver' ? (plateNumber || '') : '',
      licenseNumber: appType === 'independent_driver' ? (licenseNumber || '') : '',
      phone: appPhone || '',
